...
class TestMedReminder(unittest.TestCase):
    ...
    class TestMedList(unittest.TestCase):
        ...
        def test_get_meds_before(self):
            ...
            offset = 200
            original = 1200
            time = str(original - offset)
            day = random.choice(Utils["days_of_week"])
        ...
        def test_get_meds_window(self):
            ...
            offset = 200
            original = 1200
            timeframe = [str(original - offset), str(original + offset)]
            day = random.choice(Utils["days_of_week"])
            ...
            self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            # TODO: Compare This Check Against get_meds_after output
            expexted_test_data = test_meds_0[day][str(original)]
            our_method_results = Medications.get_current_meds(test_meds_0, day, str(original))
            error_message = f'Error Result are not what we wantExpected: {expexted_test_data} | Actual: {our_method_results}'
            self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            ...
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            # # TODO: Compare This Check Against get_meds_after output
            # expexted_test_data = test_meds_1[day][str(original)]
            # our_method_results = Medications.get_current_meds(test_meds_1, day, str(original))
            # error_message = f'Error Result are not what we wantExpected: {expexted_test_data} | Actual: {our_method_results}'
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            ...
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            # # TODO: Compare This Check Against get_meds_after output
            # expexted_test_data = test_meds_2[day][str(original)]
            # our_method_results = Medications.get_current_meds(test_meds_2, day, str(original))
            # error_message = f'Error Result are not what we wantExpected: {expexted_test_data} | Actual: {our_method_results}'
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            ...
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
            # # TODO: Compare This Check Against get_meds_after output
            # expexted_test_data = test_meds_3[day][str(original)]
            # our_method_results = Medications.get_current_meds(test_meds_3, day, str(original))
            # error_message = f'Error Result are not what we wantExpected: {expexted_test_data} | Actual: {our_method_results}'
            # self.assertDictEqual(our_method_results, expexted_test_data, error_message)
